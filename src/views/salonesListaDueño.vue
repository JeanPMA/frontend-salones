<template>
    ...
    <div class="search_listaSalon">
            <div class="search-container">
                <input type="text" id="search-input" placeholder="Buscar...">
                <button id="search-button">Buscar</button>
             </div>
             <div class="salonesDueño_filter">
...
.dueño_gridSalones{
  ...
  .dueño_gridSalones .grid-containerDueño {
    display: grid;
  ...
  .dueño_gridSalones .grid__itemSalon .text-title{
    width: 100%;
    height: 100px;

    
  }
  .dueño_gridSalones .grid-containerDueño .text-title img{
    width: 100%;
    height: 100%;
